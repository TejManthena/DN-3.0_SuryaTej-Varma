 ...
 * Binary search is more suitable for large sorted datasets due to its
 * logarithmic time complexity, compared to the linear time complexity of linear
 * search.
 * 
 */